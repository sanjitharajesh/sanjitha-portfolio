  ...
  return (
    <>
      <h2
        ref={headingRef}
        id="experience"
        className={`font-inter font-bold text-[clamp(28px,4vw,38px)] mt-12 md:mt-20 mb-12 scroll-mt-36 text-center transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3"}`}
      >
